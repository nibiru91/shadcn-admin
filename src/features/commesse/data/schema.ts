...
export const commessaSchema = z.object({
  ...
  ore_previste: z.coerce.number().min(0).optional().nullable().default(0),
  ore_pianificate: z.coerce.number().min(0).optional().nullable().default(0),
  ore_consuntivate: z.coerce.number().min(0).optional().nullable().default(0),
  ore_residue: z.coerce.number().optional().nullable().default(0),
  ore_fatturate: z.coerce.number().optional().nullable(),
  tariffa_oraria: z.coerce.number().min(0).default(0),
  ...
  cliente_diretto: z.coerce.number().optional().nullable(),
  cliente_fatturazione: z.coerce.number().optional().nullable(),
